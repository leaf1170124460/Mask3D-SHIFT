...
val_ann_file = 'minival/front/det_3d.json'

train_img_prefix = 'train/front/img.zip'
val_img_prefix = 'minival/front/img.zip'

train_insseg_ann_file = 'train/front/det_insseg_2d.json'
val_insseg_ann_file = 'minival/front/det_insseg_2d.json'

train_depth_prefix = 'train/front/depth_8bit.zip'
val_depth_prefix = 'minival/front/depth_8bit.zip'
...
load_from = '<YOUR_CHECKPOINT_DIR>/checkpoint/detr3d_resnet101.pth'
