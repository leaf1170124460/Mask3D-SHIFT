...
class DetectionEval:
    ...
    def __init__(self,
        ...
        for i in range(len(self.gt_boxes.sample_tokens)):
            if self.gt_boxes.sample_tokens[i] in self.pred_boxes.sample_tokens:
                gt_boxes.add_boxes(self.gt_boxes.sample_tokens[i], self.gt_boxes.boxes[self.gt_boxes.sample_tokens[i]])
